...
#       # TODO:
#       #   1. x = x + self.attn(self.norm1(x))   # residual around attention
#       #   2. x = x + self.mlp(self.norm2(x))    # residual around MLP
#       #   3. return x
#       #
#       #   That's it!  The block is beautifully simple once the sub-layers
#       #   are implemented.
#       #
